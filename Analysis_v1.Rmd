...
ggplot(RealData, aes(x = SleepScore, y = Concentration)) +
  ...
  geom_smooth(method = "lm") +
  labs(
    title = "Concentration vs. Schlafscore",
    x = "Schlafscore",
    y = "Concentration"
  )
...
ggplot(subset(RealData, Time %in% c(3, 5)), 
  ...
  geom_boxplot() +
  labs(title = "Energylevel nach 3h & 5h: Protein vs. KH",
       x = "Stunden nach Frühstück", y = "Energy")
...
ggplot(subset(RealData, Time %in% c(3, 5)), 
  ...
  geom_boxplot() +
  labs(title = "Fatigue nach 3h & 5h: Protein vs. KH",
       x = "Stunden nach Frühstück", y = "Fatigue")
...
ggplot(RealData, aes(x = Time, y = Concentration, color = Intervention)) +
  geom_jitter(width = 0.3, alpha = 0.3) +
  labs(title = "Verlauf der Concentration", y = "Concentration")
...
ggplot(RealData, aes(x = Measurement, y = Energy+Fatigue)) +
  geom_line() +
  labs(
    title = "Verlauf von Energy + Fatigue",
    y = "Energy + Fatigue",
    x = "Measurement"
  )
...
ggplot(RealData, aes(x = SleepScore, y = Fatigue, color = Intervention)) +
  geom_point() +
  geom_smooth(method = "lm") +
  labs(title = "Fatigue ~ Schlafscore", x = "Schlafscore", y = "Fatigue")
